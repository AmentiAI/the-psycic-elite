...
import { Moon, ExternalLink, ArrowLeft } from "lucide-react"

export const metadata: Metadata = {
  title: "Dream Interpretation Services | The Conjuring House",
  description: "Understand the hidden messages and symbols within your dreams. Unlock the wisdom of your subconscious mind through professional dream analysis.",
  keywords: "dream interpretation, dream analysis, subconscious, dream symbols, prophetic dreams, nightmare resolution",
  openGraph: {
    title: "Dream Interpretation Services | The Conjuring House",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Unlock the wisdom of your subconscious mind through professional dream analysis. Our dream interpreters help you 
                understand recurring dreams, nightmares, and prophetic visions, revealing the deeper meanings and guidance your dreams contain.
              </p>
            ...
            <div className="relative">
              <img 
                ...
                alt="Dream interpretation session"
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8">
            Discover the hidden messages and guidance within your dreams.
          </p>
